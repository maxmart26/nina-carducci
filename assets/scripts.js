...
document.body.onload=function(){
    ...
    for(i=1;i<=nbr;i++){
        ...
        img.className="photo";
        img.src='./assets/images/slider/carousel'+i+'.webp';
...
d.onclick=function(){
    ...
    if(p>-nbr+1){
        p--;
    container.style.transform="translate("+p*1950+"px)";
...
function addListenerS(){
    button=document.getElementsByClassName("button-carrousel")
